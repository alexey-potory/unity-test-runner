...
This guide installs `unity-test-runner` as a local Codex MCP server on macOS.
...
command = "/Users/<you>/Tools/unity-test-runner/bin/unity-test-runner"
args = ["mcp"]
...
```toml
cwd = "/Users/<you>/Projects/MyUnityGame"
```
